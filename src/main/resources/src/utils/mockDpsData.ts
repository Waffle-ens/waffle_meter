...
export const injectMockDpsData = () => {
  ...
  (window as any).javaBridge = {
    ...
    openPacketLogFolder: () => "C:\\Users\\Waffle\\AppData\\Roaming\\waffle_meter.v1.4\\packet-debug-logs",
    ...
    openStatsUploadFolder: () =>
      "C:\\Users\\Waffle\\AppData\\Roaming\\waffle_meter.v1.6.9-dev\\stats-upload",
